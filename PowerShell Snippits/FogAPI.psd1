...
@{
    ...
    FunctionsToExport = 'Add-FogHostMac', 'Approve-FogPendingMac', 'Deny-FogPendingMac', 
                   ...
                   'Get-FogModules', 'Get-FogObject', 'Get-FogServerSettings', 
                   'Get-FogSnapins', 'Get-PendingMacsForHost', 'Install-FogService', 
                   'Invoke-FogApi', 'New-FogHost', 'New-FogObject', 'Remove-FogObject', 
                   'Remove-UsbMac', 'Reset-HostEncryption', 'Set-FogInventory', 
                   'Set-FogServerSettings', 'Set-FogSnapins', 'Start-FogSnapins', 
                   'Update-FogObject'
    ...
    # 2103.2.12
        ...
        updated set-fogsnapin help and removed erroneous parameter
