<#
.SYNOPSIS
  Adds Servicetag to objects.

.DESCRIPTION
  Adds Servicetag to objects like AD or FOG API
...
#---------------------------------------------------------[Initialisations ]--------------------------------------------------------
#computername function parameter
# pulls service tag and adds to AD, and eventually FOG if we can work with the API.
