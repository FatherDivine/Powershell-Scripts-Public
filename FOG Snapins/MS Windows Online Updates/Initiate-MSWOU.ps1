...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/FatherDivine/Powershell-Scripts-Public/main/MS%20Windows%20Online%20Updates/Logging_Functions.ps1" -OutFile "${PSScriptRoot}\Logging_Functions.ps1" -Verbose
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/FatherDivine/Powershell-Scripts-Public/main/MS%20Windows%20Online%20Updates/Invoke-WUInstall.ps1" -OutFile "${PSScriptRoot}\Invoke-WUInstall.ps1" -Verbose
