<#
  .SYNOPSIS
    Installs Chocolatey for CEDC Students.

  .DESCRIPTION
    This script installs Chocolatey with the
    settings necessary for CEDC Students.
...
choco source add --name="'CEDC Student'" --source="'http://cedc-nc2413-z1:8081/repository/CEDCS/'" --priority="'0'" -u="$global:Username" -p="$global:Password"
