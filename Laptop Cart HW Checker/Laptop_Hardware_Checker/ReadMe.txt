*Version 1.6 is still under development (Need new logic for FC command to automatically compare, given time and tech notes will always be different.. may have to drop timestamp and put tech notes in a separate file). 
...
III Requirements
------------------------------------------------------------
Native windows environment. We made sure to not need anything else but what comes with basic windows (hence the use of Powershell for e-mail).
