...
echo.
for /f %%C in ('type "C:\Users\cladmin\Desktop\LCHWC\compare.txt" ^| find /c /i "error"') do if %%C LSS 1 (echo [92mNO PROBLEMS DETECTED[0m) else (echo [91mPALERT !! PROBLEMS DETECTED! CHECK compare.txt, PreHardware.txt & PostHardware.txt!![0m) 
goto :EOF
echo.
::::::::::::::::::::::::::::::::::::::::::::
