...
rem :: TYPE C:\Users\cladmin\Desktop\LCHWC\time.tmp  > C:\Users\cladmin\Desktop\LCHWC\PostHardware.txt
...
<html>
<head><title>No Problems!</title></head>
<body bgcolor="green"><h1><font size="20" color="white" face="verdana">NO PROBLEMS DETECTED! LAPTOP PASSED HARDWARE CHECK SUCCESSFULLY!</h1></font ></body>
...
</html>) else (echo "ALERT !! PROBLEMS DETECTED! CHECK compare.txt, PreHardware.txt & PostHardware.txt!!"
	color F
	timeout 1 >nul
	color C
        timeout 1 >nul
...
echo.
wmic /OUTPUT:C:\Users\cladmin\Desktop\LCHWC\time.tmp os get LocalDateTime
rem :: TYPE C:\Users\cladmin\Desktop\LCHWC\time.tmp > C:\Users\cladmin\Desktop\LCHWC\PreHardware.txt
